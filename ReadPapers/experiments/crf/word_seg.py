...
## baidu-yunpan: /datadrive/nlp/training/msr_training.utf8
tr_path = '/home/zyl/Projects/crfs_00/chinesetokenization/icwb2-data/training/msr_training.utf8'
sents = open(tr_path).read()
sents = sents.strip() #sents.decode('utf-8').strip()
sents = sents.split('\n') # 这个语料的换行符是\r\n
...
train_sents = sents[:-1000] # 留下5000个句子做验证，剩下的都用来训练
valid_sents = sents[-1000:]
